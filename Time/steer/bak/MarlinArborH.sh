...
/besfs/groups/higgs/users/zhaoh/cepc/myWorkSpace/SimplifiedGeometry/Generator/data/ScCal/H_diphoton/cellsize1mm_L30_W28_Sc2/H_diphoton_cellsize1mm_L30_W28_Sc2_${n}.slcio
     </parameter>
     <parameter name=\"GearXMLFile\" value=\"/besfs/groups/higgs/users/zhaoh/cepc/myWorkSpace/SimplifiedGeometry/Generator/data/ScCal/H_diphoton/cellsize1mm_L30_W28_Sc2/GearOutput.xml\"/>
     ...
     <parameter name=\"LCIOOutputFile\" type=\"string\" >
         H_diphoton_CellSize${CellSize}mm_L30_Sc2_W28_${n}_reco.slcio
     </parameter>
     ...
     AnaClu_H_diphoton_CellSize${CellSize}mm_${n}.root
     </parameter>
